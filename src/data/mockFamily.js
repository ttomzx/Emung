export const mockMembers = [
  {
    _id: "m1",
    name: "Ningthouba Meitei",
    relation: "Patriarch / Great-Grandfather",
    generation: 1,
    gender: "male",
    dateOfBirth: "1924-03-15",
    dateOfDeath: "2010-11-20",
    biography: "Founder of the family estate in Imphal. Known for his wisdom, devotion to traditional craftsmanship, and community leadership.",
  ...
  {
    _id: "m2",
    name: "Leimakhubi Chanu",
    relation: "Matriarch / Great-Grandmother",
    generation: 1,
    gender: "female",
    dateOfBirth: "1928-07-09",
    dateOfDeath: "2015-04-12",
